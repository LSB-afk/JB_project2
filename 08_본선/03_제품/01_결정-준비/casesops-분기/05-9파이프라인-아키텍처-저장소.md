...
| 정본 도메인 엔티티 | [[08_본선/03_제품/docs/05_domain-model|05_domain-model]] | `Case → AgentRun → Agent → Skill → Evidence → Approval → Audit` 운영 계약만 인용 |
| 정본 아키텍처 | [[08_본선/03_제품/docs/07_architecture|07_architecture]] | 신뢰경계·모델 라우팅·Human approval·Failure handling을 파이프라인에 끼워 넣음 |
...
- [[03-119-사고대응-에이전트]]
- [[04-은행DB연결-특화모델]]
- [[08_본선/03_제품/docs/07_architecture|07_architecture]]
- [[08_본선/03_제품/docs/05_domain-model|05_domain-model]]
- [[D09-요약]]
- [[D20-요약]]
- [[B01-요약]]
- [[D11-요약]]
